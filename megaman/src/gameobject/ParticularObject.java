...
public abstract class ParticularObject extends GameObject {// đối tượng cụ thể game khác so với đối tượng cụ thể
            ...
            case ALIVE:
                ...
                if(object!=null){
                    if(object.getDamage() > 0){
                        ...
                        beHurt(object.getDamage()); // Đối tượng bị nhận damage và bị trừ máu
                    }
